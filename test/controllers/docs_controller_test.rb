...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { argument: @doc.argument, file: @doc.file, name: @doc.name, thirdpart_id: @doc.thirdpart_id } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { argument: @doc.argument, file: @doc.file, name: @doc.name, thirdpart_id: @doc.thirdpart_id } }
